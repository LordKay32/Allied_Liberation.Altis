...
private _text = format ["<t size='0.6'>Allied mortars are sending <t size='0.6' color='#808080'>flares</t> to illuminate the battlefield near your position.</t>"];
...
for "_i" from 1 to _flareCount do {
    private _flareModel = "LIB_40mm_White";
