...
private _text = format ["<t size='0.6'>Allied mortars are sending <t size='0.6' color='#808080'>smoke shells</t> to cover your position.</t>"];
...
for "_i" from 1 to _smokeCount do {
    ...
    private _smokeRound = "LIB_US_M18" createVehicle _randomizedPosition;
