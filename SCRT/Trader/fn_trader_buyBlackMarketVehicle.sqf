...
if (_resourcesFIA < vehiclePurchase_cost) exitWith {
    ["Vehicle Market", format ["You do not have enough command points for this vehicle: %1 %2 required",vehiclePurchase_cost,currencySymbol]] call SCRT_fnc_misc_showDeniedActionHint;
};
