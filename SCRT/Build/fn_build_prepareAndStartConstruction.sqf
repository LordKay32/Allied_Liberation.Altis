...
switch(_constructionType) do {
    case("TRENCH"): {
        construction_buildingsAvailable = ["Land_BagFence_Long_F", "Land_BagFence_Short_F", "Land_BagFence_Round_F", "Land_BagFence_Corner_F"];
        construction_cost = 50;
        construction_buildTime = 30;
    };
    case("OBSTACLE"): {
        construction_buildingsAvailable = ["Land_SandbagBarricade_01_half_F", "Land_SandbagBarricade_01_hole_F", "Base_WarfareBBarrier5x"];
    ...
    case("CONCRETE_BUNKER"): {
        construction_buildingsAvailable = ["Land_BagBunker_Tower_F","Land_BagBunker_Large_F"];
        construction_cost = 500;
        construction_buildTime = 120;
    };
    case("MISC"): {
        construction_buildingsAvailable = ["CamoNet_BLUFOR_F", "CamoNet_BLUFOR_open_F", "CamoNet_BLUFOR_big_F", "Land_LampShabby_F"];
...
if (_money < construction_cost) exitWith {
    ["Construction", format ["You do not have enough command points for this construction: %1%2 required", construction_cost, currencySymbol]] call SCRT_fnc_misc_showDeniedActionHint;
    construction_buildingsAvailable = nil;
    construction_buildingIndex = nil;
    construction_cost = nil; 
    construction_selectedEngineer = nil;
