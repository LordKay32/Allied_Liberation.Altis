...
lbSetTooltip [1750, 2, "Plane flies over and drops a Willy's jeep to the specified position."];
...
lbAdd [2750, "Light Roadblock"];
lbSetData [2750, 1, "LIGHTROADBLOCK"];
lbAdd [2750, "Heavy Roadblock"];
lbSetData [2750, 2, "ROADBLOCK"];
lbAdd [2750, "HMG Emplacement"];
lbSetData [2750, 3, "HMG"];
lbAdd [2750, "AA Emplacement"];
lbSetData [2750, 4, "AA"];
lbAdd [2750, "AT Emplacement"];
lbSetData [2750, 5, "AT"];
lbAdd [2750, "Artillery Emplacement"];
lbSetData [2750, 6, "MORTAR"];
lbAdd [2750, "Support Post"];
lbSetData [2750, 7, "SUPPORTPOST"];

lbSetCurSel [2750, 0];

//Minefield Combobox 
lbAdd [2758, "M3 AP Mines"];
lbSetData [2758, 0, "APERSMine"];
lbAdd [2758, "M1A1 AT Mines"];
