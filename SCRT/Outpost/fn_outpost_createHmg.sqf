...
[[teamPlayer,civilian],_taskId,["We are sending a team to establish an HMG emplacement. Use HC to send the team to their destination.","HMG Emplacement Deploy",_marker],_position,false,0,true,"Move",true] call BIS_fnc_taskCreate;
[_taskId, "outpostTask", "CREATED"] remoteExecCall ["A3A_fnc_taskUpdate", 2];

_formatX = [UKSL,UKMG,UKMG,UKMedic,UKMil,UKMil];
