...
if !(call HR_GRG_Cnd_canAccessSea) then {
    private _seaBttn = _disp displayCtrl HR_GRG_IDC_BttnBoats;
    _seaBttn ctrlEnable false;
    _seaBttn ctrlSetTextColor [0.7,0,0,1];
    _seaBttn ctrlSetTooltip localize "STR_HR_GRG_Generic_SeaDisabled";
};

if !(call HR_GRG_Cnd_canAccessHeavy) then {
    private _heavyBttn = _disp displayCtrl HR_GRG_IDC_BttnArmor;
    _heavyBttn ctrlEnable false;
    _heavyBttn ctrlSetTextColor [0.7,0,0,1];
    _heavyBttn ctrlSetTooltip localize "STR_HR_GRG_Generic_HeavyDisabled";
};

if !(call HR_GRG_Cnd_canAccessLight) then {
    private _lightBttn = _disp displayCtrl HR_GRG_IDC_BttnCars;
    _lightBttn ctrlEnable false;
    _lightBttn ctrlSetTextColor [0.7,0,0,1];
    _lightBttn ctrlSetTooltip localize "STR_HR_GRG_Generic_LightDisabled";
};
