...
switch _callBackName do {
    ...
    case "HCSquadVehicle": {
        switch _action do {
            case "invalidPlacement": {
                [getMarkerPos ([(["Synd_HQ"] + airportsX + milbases), position player] call BIS_fnc_nearestPosition) distance _vehicle > 100, "You cant place HC vehicles further than 100m from the flag"];
            };
            case "Placed": {
