...
class Params
{
    ...
    class unlockItem
    {
        ...
        values[] = {9999,15,20,25,30,35,40,45,50,100,200,500,1000000};
        texts[] = {"Load From Save (Default - 25)","15","20","25","30","35","40","45","50","100","200","500","1,000,000"};
        default = 1000000;
    };
    ...
    class Spacer11
    {
     ...
     class playerStartingMoney
     {
          ...
          values[] = {9999, 0, 100, 200, 500, 1000, 2000};
          texts[] =  {"Load From Save (Default - 200)", "0", "100", "200", "500","1000","2000"};
          default = 2000;
     };
