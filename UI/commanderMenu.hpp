		...
		class GarrisonTab: RscControlsGroup 
		{
			...
			{		
				...
				{			
					...
					sizeEx = "((pixelH * (pixelGridNoUIScale) * 2) * 1.25) * 0.5";	
					shadow = 2;	
					action = "['delete'] spawn A3A_fnc_mineDialog;";
				};
			};
		};
		...
		class HqTab: RscControlsGroup 
		{
			...
			class Controls {	
				...
				{			
					...
					sizeEx = "((pixelH * (pixelGridNoUIScale) * 2) * 1.25) * 0.5";	
					shadow = 2;	
					action = "[] call SCRT_fnc_ui_logistics;";
				};
				...
				class logisticsTitle: TextBase
				{
					idc = 3106;
					text = "";
					x = "1 * pixelGridNoUIScale * pixelW";
					y = "18.2 * pixelGridNoUIScale * pixelH";	
					w = "22 * pixelGridNoUIScale * pixelW";	
					h = "1.5 * pixelGridNoUIScale * pixelH";
				};

				class resourcesIncome: TextBase
				{
					idc = 3107;
					text = "";
					x = "1 * pixelGridNoUIScale * pixelW";
					y = "19.7 * pixelGridNoUIScale * pixelH";	
					w = "22 * pixelGridNoUIScale * pixelW";	
					h = "1.5 * pixelGridNoUIScale * pixelH";
				};
				
				class resourcesPlayer: TextBase
				{
					idc = 3108;
					text = "";
					x = "1 * pixelGridNoUIScale * pixelW";
					y = "20.8 * pixelGridNoUIScale * pixelH";	
					w = "22 * pixelGridNoUIScale * pixelW";	
					h = "1.5 * pixelGridNoUIScale * pixelH";
				};
				
				class hrAllies: TextBase
				{
					idc = 3109;
					text = "";
					x = "1 * pixelGridNoUIScale * pixelW";
					y = "21.9 * pixelGridNoUIScale * pixelH";	
					w = "22 * pixelGridNoUIScale * pixelW";	
					h = "1.5 * pixelGridNoUIScale * pixelH";
				};
				
				class hrSDK: TextBase
				{
					idc = 3110;
					text = "";
					x = "1 * pixelGridNoUIScale * pixelW";
				...
				class planesIntake: TextBase
				{
					idc = 3112;
					text = "";
					x = "1 * pixelGridNoUIScale * pixelW";
					y = "25.2 * pixelGridNoUIScale * pixelH";	
					w = "22 * pixelGridNoUIScale * pixelW";	
					h = "1.5 * pixelGridNoUIScale * pixelH";
				};
				
				class weaponsIntake: TextBase
				{
					idc = 3113;
					text = "";
					x = "1 * pixelGridNoUIScale * pixelW";
					y = "26.3 * pixelGridNoUIScale * pixelH";	
					w = "22 * pixelGridNoUIScale * pixelW";	
					h = "1.5 * pixelGridNoUIScale * pixelH";
				};
				
				class magazinesIntake: TextBase
				{
					idc = 3114;
					text = "";
					x = "1 * pixelGridNoUIScale * pixelW";
					y = "27.4 * pixelGridNoUIScale * pixelH";	
					w = "22 * pixelGridNoUIScale * pixelW";	
					h = "1.5 * pixelGridNoUIScale * pixelH";
				};
				
				class itemsIntake: TextBase
				{
					idc = 3115;
					text = "";
					x = "1 * pixelGridNoUIScale * pixelW";
					y = "28.5 * pixelGridNoUIScale * pixelH";	
					w = "22 * pixelGridNoUIScale * pixelW";	
					h = "1.5 * pixelGridNoUIScale * pixelH";
				};
				...
				{
					idc = 3116;					
					y = "30.2 * pixelGridNoUIScale * pixelH";	
				};
