...
switch (true) do
{
    case (_enemy isKindOf "Man"):
    {
        ...
        if(_enemiesNearEnemy > 6) then
        {
            ...
            ) then
            {
                ...
                _supportTypes = ["MORTAR", "AIRSTRIKE", "AIRDROP", "QRF"];
            };
        }
        else
        {
            if(_enemiesNearEnemy > 2) then
            {
                ...
                ) then
                {
                    ...
                    _supportTypes = ["AIRSTRIKE", "MORTAR", "QRF"];
                };
            }
            else
            {
    ...
    case (_enemyVehicle isKindOf "StaticWeapon"):
    {
        ...
        _supportTypes = ["AIRSTRIKE", "MORTAR"];
    };
    case (_enemyVehicle isKindOf "Tank"):
    {
        ...
        ) then
        {
            ...
            _supportTypes = ["MORTAR", "AIRSTRIKE"];
        };
    };
...
private _nearHouses = call {
	if (side _group in [Occupants, Invaders]) exitWith { 0 };		// invaders are fine with bombing towns
...
if (_friendlyCount > _maxFriendlies or _nearHouses > _maxHouses) then
{
    ...
    _supportTypes = _supportTypes - ["MORTAR", "AIRSTRIKE"];
};
