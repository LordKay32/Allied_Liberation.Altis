...
} count roadblocksFIA + watchpostsFIA + aapostsFIA + atpostsFIA + mortarpostsFIA + lightroadblocksFIA + hmgpostsFIA + supportpostsFIA);
...
} forEach (markersX - citiesX - controlsX - watchpostsFIA - roadblocksFIA - aapostsFIA - atpostsFIA - mortarpostsFIA - lightroadblocksFIA - hmgpostsFIA - supportpostsFIA) select {sidesX getVariable [_x,sideUnknown] != _sideX};
