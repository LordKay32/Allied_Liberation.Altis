...
switch (_x) do
	...
	case "LIB_US_M18": {_muzzles pushBack "LIB_SmokeShellMuzzle"};
	case "LIB_US_M18_Green": {_muzzles pushBack "SmokeShellGreenMuzzle"};
	case "LIB_US_M18_Red": {_muzzles pushBack "SmokeShellRedMuzzle"};
	case "LIB_US_M18_Yellow": {_muzzles pushBack "SmokeShellYellowMuzzle"};
