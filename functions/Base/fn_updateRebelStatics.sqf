...
private _freeStatics = _statics select {
    (typeOf _x in ([USMGStatic, UKMGStatic, M2MGStatic, staticATteamPlayer, staticAAteamPlayer, staticATOccupants] + NATOMG + staticAAOccupants))
...
_possibleCrew = _possibleCrew select {
    ...
    and (_x getVariable ["UnitType", ""]) in [USMil, UKMil]
