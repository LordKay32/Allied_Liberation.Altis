...
if (_newGame) exitWith {placementDone = true; publicVariable "placementDone"; chopForest = false; publicVariable "chopForest"; posHQ = getMarkerPos respawnTeamPlayer; publicVariable "posHQ"};
