...
while {true} do
{
    ...
    if(gameMode != 4) then
    {
        ...
        attackCountdownOccupants = attackCountdownOccupants - (30 * (0.5 + (aggressionOccupants/100)));
    ...
    if (gameMode != 3) then
    {
        ...
        attackCountdownInvaders = attackCountdownInvaders - (25 * (0.5 + (aggressionInvaders/100)));
