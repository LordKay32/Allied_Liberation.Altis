...
_fnc_initMarker =
{
...

	{
		...
		if (_x in (resourcesX + factories + outposts + ["seaport_3","seaport_4","seaport_6","seaport_7","seaport_8"])) then {_mrk setMarkerSize [0.6, 0.6]} else {_mrk setMarkerSize [0.75, 0.75]};

		if (_x in airportsX) then
		{
			private _flagType = if (_x in _mrkCSAT) then {"plp_mark_civ_airport2"} else {"plp_mark_civ_airport2"};
...
[_mrkCSAT, airportsX, "plp_mark_civ_airport2", "%1 Airbase", true] call _fnc_initMarker;
[_mrkCSAT, resourcesX, "plp_mark_as_industrial", "Resources"] call _fnc_initMarker;
[_mrkCSAT, factories, "plp_mark_as_industrial", "Factory"] call _fnc_initMarker;
[_mrkCSAT, outposts, "plp_mark_as_watchtower", "%1 Outpost", true] call _fnc_initMarker;
[_mrkCSAT, ["seaport_4","seaport_6","seaport_7","seaport_8"], "plp_mark_as_pier", "Dock"] call _fnc_initMarker;
[_mrkCSAT, ["seaport","seaport_1","seaport_2","seaport_3","seaport_5"], "plp_mark_civ_harbor", "Port"] call _fnc_initMarker;
[_mrkCSAT, milbases, "plp_mark_civ_embassy", "%1 Military Base", true] call _fnc_initMarker;
