...
server setVariable [vehSDKPlaneUK3,2400,true];
server setVariable [vehSDKPlaneUS1, 2500, true];
server setVariable [vehSDKPlaneUS2, 2600, true];
server setVariable [vehSDKPlaneUS3, 5000, true];
server setVariable [vehUKPayloadPlane, 5000, true];
server setVariable [vehUSPayloadPlane, 6000, true];
