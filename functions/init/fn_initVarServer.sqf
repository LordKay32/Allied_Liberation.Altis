...
{server setVariable [_x,25,true]} forEach [UKMil, USMil, SDKMil];
{server setVariable [_x,50,true]} forEach (sdkTier1 - [UKMil, USMil, SDKMil]);
{server setVariable [_x,75,true]} forEach sdkTier2;
{server setVariable [_x,100,true]} forEach sdkTier3;
{server setVariable [_x,150,true]} forEach sdkTier4;
{server setVariable [_x,200,true]} forEach sdkTier5;
...
server setVariable [civTruck,500,true];
server setVariable [civBoat,150,true];
...
server setVariable [vehSDKLightArmed, 350, true];
server setVariable [vehSDKRepair, 500, true];
server setVariable [vehSDKFuel, 500, true];
server setVariable [vehSDKAmmo, 600, true];
server setVariable [vehSDKMedical, 500, true];
server setVariable [vehSDKHeavyArmed,700,true];
server setVariable [vehSDKAPCUK1,600,true];
...
server setVariable [vehSDKTankUSM5, 1800, true];
server setVariable [vehSDKTankUSM4, 2400, true];
server setVariable [vehSDKPlaneUK1, 2000, true];
server setVariable [vehSDKPlaneUK2,2000,true];
server setVariable [vehSDKPlaneUK3,2500,true];
server setVariable [vehSDKPlaneUS1, 2400, true];
server setVariable [vehSDKPlaneUS2, 3000, true];
server setVariable [vehSDKPlaneUS3, 5000, true];
server setVariable [vehUKPayloadPlane, 6000, true];
server setVariable [vehUSPayloadPlane, 5000, true];
server setVariable [vehSDKTransPlaneUK, 1800, true];
server setVariable [vehSDKTransPlaneUS, 1800, true];
server setVariable [vehInfSDKBoat, 800, true];
server setVariable [vehSDKBoat, 1200, true];
...
server setVariable [SDKArtillery, 1000, true];
