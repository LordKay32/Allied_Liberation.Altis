...
// So if "Tank_F" is in both NATOLand and NATOTanks, NATOTanks should be ABOVE NATOLand, as NATOTanks is a specialised child.
    ...
    [vehFixedWing,[NATOPilot, CSATPilot, USPilot, "C_Man_1"]],
    [vehTanks, [NATOCrew, CSATCrew, USCrew, "C_Man_1"]],
    [vehHelis, [NATOPilot, CSATPilot, USPilot, "C_Man_1"]],
    [vehUAVs, ["B_UAV_AI", "O_UAV_AI", "I_UAV_AI", "C_UAV_AI"]],
    [vehFIA, [FIARifleman, WAMRifleman, USstaticCrewTeamPlayer, "C_Man_1"]],
    [vehPoliceCars, [policeGrunt, policeGrunt, USstaticCrewTeamPlayer, "C_Man_1"]]
];
