...
_ammoTruck = nearestObjects [player, [vehSDKAmmo], 100];
if (!(_ammoTruck isEqualTo []) && (typeOf _veh in [UKMGStatic, USMGStatic, staticATteamPlayer, staticAAteamPlayer, SDKMortar, SDKArtillery])) then {_closeX append _ammoTruck};
