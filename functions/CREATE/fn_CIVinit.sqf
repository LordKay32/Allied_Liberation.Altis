...
if (uniform _unit == "U_LIB_CIV_Priest") then {} else {_unit addHeadgear selectRandom (A3A_faction_civ getVariable "headgear")};
	...
	"killed",
	{
		...
		else
		{
			...
			else
			{
				...
				{
					civilianKilledByOccupant = civilianKilledByOccupant;
