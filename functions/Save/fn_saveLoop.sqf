...
_UKhrBackground = (server getVariable "UKhr") + ({((_x getVariable "unitType") in UKTroops) and (alive _x) and (not isPlayer _x) and (_x getVariable ["spawner",false]) and ((group _x in (hcAllGroups theBoss) or (isPlayer (leader _x))) and (side group _x == teamPlayer))} count allUnits);
_SAShrBackground = (server getVariable "SAShr") + ({((_x getVariable "unitType") in SASTroops) and (alive _x) and (not isPlayer _x) and (_x getVariable ["spawner",false]) and ((group _x in (hcAllGroups theBoss) or (isPlayer (leader _x))) and (side group _x == teamPlayer))} count allUnits);
_UShrBackground = (server getVariable "UShr") + ({((_x getVariable "unitType") in USTroops) and (alive _x) and (not isPlayer _x) and (_x getVariable ["spawner",false]) and ((group _x in (hcAllGroups theBoss) or (isPlayer (leader _x))) and (side group _x == teamPlayer))} count allUnits);
_parahrBackground = (server getVariable "parahr") + ({((_x getVariable "unitType") in paraTroops) and (alive _x) and (not isPlayer _x) and (_x getVariable ["spawner",false]) and ((group _x in (hcAllGroups theBoss) or (isPlayer (leader _x))) and (side group _x == teamPlayer))} count allUnits);
_SDKhrBackground = (server getVariable "SDKhr") + ({((_x getVariable "unitType") in SDKTroops) and (alive _x) and (not isPlayer _x) and (_x getVariable ["spawner",false]) and ((group _x in (hcAllGroups theBoss) or (isPlayer (leader _x))) and (side group _x == teamPlayer))} count allUnits);
