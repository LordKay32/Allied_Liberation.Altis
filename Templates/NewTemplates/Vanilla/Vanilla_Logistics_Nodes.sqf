...
A3A_logistics_vehicleHardpoints = [
	...
	["LIB_OpelBlitz_Open_Y_Camo" call A3A_fnc_classNameToModel, [
        [1,             [0,0,-0.12],      			[1,2,7,10,11]],
        [1,             [0,-0.8,-0.12],      		[2,5,6,7]],
        [1,             [0,-1.6,-0.12],         	[3,4,5,6]],
        [1,             [0,-2.4,-0.12],           	[3,4,8,9]]
    ]],
	...
	//WW2 GMC
	["UNI_GMC_Open_OD" call A3A_fnc_classNameToModel, [
        [1,             [-0.1,-0.45,-0.65],      	[1,2,7,10]],
        [1,             [-0.1,-1.35,-0.65],      	[2,5,6,7]],
        [1,             [-0.1,-2.25,-0.65],         [3,4,5,6]],
        [1,             [-0.1,-3.15,-0.65],         [3,4,8,9]]
    ]],
...
A3A_logistics_attachmentOffset = [
    ...
    ["fow_w_m1919_tripod_usa_m41" call A3A_fnc_classNameToModel,                [0, 0.2, 0.05],            [0, -1, 0],                 2,      100],               //M2
    ...
    ["LIB_WeaponsBox_Big_GER" call A3A_fnc_classNameToModel,                    [0.2,0.4,0.1],              [0,0,0],                    2],                        //default loot crate
...
A3A_logistics_weapons = [
    ...
    ["LIB_M2_60" call A3A_fnc_classNameToModel,[]],
    //WW2
    ["fow_w_vickers_uk" call A3A_fnc_classNameToModel,[]],
    ["fow_w_m1919_tripod_usa_m41" call A3A_fnc_classNameToModel,[]],
